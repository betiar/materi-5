                                    ...
                                    <div class="card-body">
                                        <form class="form-login" action="{{url('register')}}" method="post">
                                           ...
                                           @include('template.utils.notif')
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" name="nama" type="text" placeholder="Masukkan Nama" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <input class="btn btn-primary btn-block" type="submit"/>Create Account
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="log">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Sugoi Store2020</div>
                            <div>
